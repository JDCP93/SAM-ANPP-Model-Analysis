...
The below is a plot of $\alpha_{2}$ and $\alpha_{3}$ for the sites using observed ANPP. The plots are ordered by length of data available and there is a clear correlation between this and the significance of the $\alpha_{k}$
